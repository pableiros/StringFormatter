...
Simple Text Formetter (Credit Card Number, Phone Number, Serial Number etc.) Can be used in all text inputs according to the format pattern. If desired, large minor character restrictions can be made in the format pattern.
  ...
  spec.homepage     = "https://github.com/pableiros/StringFormatter"
  ...
  spec.author             = { "pableiros" => "pablo.borquez.urquidy@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/pableiros/StringFormatter.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "StringFormatter", "StringFormatter/**/*.{h,m}"
  spec.exclude_files = "StringFormatter/Exclude"
